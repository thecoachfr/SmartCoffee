Template.factureUserLine.helpers({ 
    theMonth: function() {
        var facture = Factures.findOne( { _id: this.factureId}); 
        return moment(new Date(facture.year, facture.month)).format("MMMM YYYY");
    },
...
Template.factureUserLine.events = {
